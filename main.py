...
saver.restore(sess, "F:/mnist_web_tensorflow_demo/mnist/data/regression.ckpt")

# F:\mnist_web_tensorflow_demo\mnist\data
with tf.variable_scope("convolutional"):
    keep_prob = tf.placeholder("float")
    y2, variables = model.convolutional(x, keep_prob)
saver = tf.train.Saver(variables)
saver.restore(sess, "F:/mnist_web_tensorflow_demo/mnist/data/convolutional.ckpt")
